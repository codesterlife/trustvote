// ABI (Application Binary Interface) for our Ethereum smart contracts
// These interfaces define how we can interact with the contracts on the blockchain

// Election Factory ABI
...
// Export the ABIs for use in our application
export default {
